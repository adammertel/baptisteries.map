...
features = []
baptisterias = csv.DictReader(codecs.open('./Christian Baptisteries, 3rd-12th c. - Baptisteries.csv', 'rU'), delimiter=',', quotechar='"')
    ...
    if row['Certainty'] == 'certain or very probable':
        try:
            props = {
                ...
                "localisation_certainty": row['Certainty_of_localisation']
            }
